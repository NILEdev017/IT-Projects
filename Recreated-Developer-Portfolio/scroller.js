...
function showSlides(n) {
    ...
    let slides = document.getElementsByClassName("bottom-scroller-content");
...
const kl=document.getElementsByClassName("kl")[0];
kl.addEventListener('mouseover',()=>{
    kl.style.opacity=1;
});
kl.addEventListener('mouseleave',()=>{
    kl.style.opacity=0;
});
